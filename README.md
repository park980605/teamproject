...
* 나의 역할 : 회원 관리, 마이페이지, 비밀번호 찾기 이메일 인증 구현, 상품 상세 페이지 리뷰 정렬
* 개발 환경
...
### 2. 회원 탈퇴
![회원탈퇴](https://user-images.githubusercontent.com/104838354/177607856-83709333-9f09-40fd-9cec-3f8cc256ef20.png)
...
* 전체적인 오류 확인
* 내가 구현하지 않은 다른 파트(결제, 로그인 API 사용 등) 해보기
